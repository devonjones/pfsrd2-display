<script>
    ...
    export let senses;
    let perception_text = format_perception(senses.perception);
    let senses_text = format_special_senses(senses.special_senses);
</script>

<senses>
    <b>Perception</b> {perception_text}; {senses_text}
</senses>
